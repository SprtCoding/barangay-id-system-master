    ...
    <>
      <aside className={`${open ? "w-60" : "w-20"} flex flex-col sticky top-0 h-screen p-3 shadow pt-8 h-screen duration-300 bg-green-500 relative drop-shadow-2xl`}>
          ...
          <div className='flex gap-x-1 items-center'>
                <img src={blgulogo} className='logo' />
              ...
              <ul className='pt-12'>
                <li className='flex items-center gap-x-4 cursor-pointer pr-2 pl-3 pt-4 pb-4 hover:bg-gray-600 rounded-md text-sm text-white '>
                ...
                <li className='flex items-center gap-x-4 cursor-pointer pr-2 pl-3 pt-4 pb-4 hover:bg-gray-600 rounded-md text-sm text-white ' onClick={handleLogout}>
              ...
              <div className='static'>
                <div class="absolute bottom-0 right-0 p-4">
                  <div className='flex flex-col h-full gap-x-1 items-end'>
                    <img src={kapLogo} className='logo' />
