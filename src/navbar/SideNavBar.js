  ...
  return (
    <>
      <aside
        className={`${
          open ? "w-60" : "w-20"
        } flex flex-col sticky top-0 h-screen p-3 shadow pt-8 h-screen duration-300 bg-green-800 relative drop-shadow-2xl`}
      >
        <div className="space-y-3">
          <div className="flex gap-x-1 items-center">
            ...
            <h1
              className={`${
                !open && "scale-0"
              } text-white origin-left font-bold text-xl duration-300 title1`}
            >
              Barangay ID's
            </h1>
            <hr />
          ...
          <ul className="pt-12">
            <li className="flex items-center gap-x-4 cursor-pointer px-4 pl-3 pt-4 pb-4 hover:bg-green-700 rounded-md text-sm text-white ">
            ...
            <li
              className="flex items-center gap-x-4 cursor-pointer px-4 pl-3 pt-4 pb-4 hover:bg-green-700 rounded-md text-sm text-white "
