              ...
              <div className="md:grid md:grid-cols-3 md:gap-6">
                <div className="md:col-span-1">
                  ...
                  <div className="flex flex-col justify-center my-4">
                    <h5 className="text-base text-center font-semibold pb-2">
                      Camera
                    </h5>
                  ...
                  <div className="flex flex-col justify-center my-4">
                    <h5 className="text-base text-center font-semibold pb-4">
                      Draw Signature Here
                    </h5>
                    {sign ? (
                      <>
                        ...
                        <div className="grid grid-cols-6 gap-6 h-full">
                          <div className="grid grid-cols-7 gap-2 col-span-6">
                            <div className="col-span-7 sm:col-span-6 lg:col-span-2">
                              <label className="after:content-['*'] after:ml-0.5 after:text-red-500 block text-base font-medium text-gray-700">
                                First Name
                              </label>
                              <input
                                type="text"
                          ...
                          <div className="col-span-6 sm:col-span-3 lg:col-span-3">
                            <label className="after:content-['*'] after:ml-0.5 after:text-red-500 block text-base font-medium text-gray-700 pb-2">
                              Civil Status
                            </label>
                            <FormControl className="mt-1 block w-full border-gray-300 shadow-sm focus:outline-none sm:text-sm py-2 border-b-2 border-gray-400">
                              ...
                              >
                                ...
                                <MenuItem value={"In certain cases"}>
                                  In certain cases
                                </MenuItem>
                          ...
                          <div className="col-span-6 sm:col-span-6 lg:col-span-2">
                            <label className="after:content-['*'] after:ml-0.5 after:text-red-500 block text-base font-medium text-gray-700 pb-4">
                              Registration Number
                            </label>
                            <input
                              type="text"
                          ...
                          <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                            <label className="block text-base font-medium text-gray-700 pb-4">
                              Precinct Number
                            </label>
                            <input
                              type="text"
